...
function filterAppareilAlgorithme(){
    ...
    let resultatFilter = allRecetteList.filter((recette) => recette.appliance.toString().toLowerCase().includes(filterWordList.toString()));
    console.log('test', resultatFilter);
